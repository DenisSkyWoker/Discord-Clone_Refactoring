...
export function connectToChat() {
    ...
    ws.onmessage = (event) => {
        ...
        if (data.type === 'system') {
            ...
            // ✅ ИСПРАВЛЕНО: убраны пробелы в операторах
            ...
            // ✅ ИСПРАВЛЕНО: addMessage без пробелов
            addMessage(
                data.nickname,
                data.content,
                data.time,
            ...
            // ✅ ИСПРАВЛЕНО: updateMessageStatus без пробелов
            ...
            // ✅ ИСПРАВЛЕНО: currentChannel без пробелов
...
// ✅ УДАЛИТЬ дублирующий обработчик Enter отсюда!
// Он теперь только в app.js